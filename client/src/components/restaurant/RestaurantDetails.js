...
import MapBoxRestaurant from './MapBoxRestaurant';
...
const removeRestaurant = async (id) => {
  ...
  // }
      ...
      await toast.promise(promise, {
        pending: {
          render: 'Deleting your restaurant...',
          // disable the delay for pending state
          delay: undefined
        },
        success: {render: 'Restaurant deleted successfully!', delay: 500},
      ...
      {isEditing ? <EditRestaurantForm 
        ...
        (<Container>
           ...
           <Grid item md={6} sx={{margin:'0 auto'}}>
            <Card sx={{ 
              maxWidth: 600, mt: '7rem', 
              borderRadius: '0.5rem', 
              boxShadow: '10px 10px 20px -10px #EACDF2, -10px 0 20px -10px #EACDF2'}}>
              ...
              />
                ...
                <CardContent>
                  <div>
                      <div style={{display: 'flex', justifyContent:'space-between'}}>
                        ...
                        <Typography fontWeight= '500' color='white'sx={{justifySelf: 'flex-end'}} variant='h5'> {details.averageRating ? details.averageRating : null }</Typography>
                        </div>
                      </div>
                ...
                <Typography sx={{mt: '10%'}}  color="text.secondary" variant="subtitle2" textAlign='end'>
                  ...
                  <EuroSymbolIcon sx={{height: '1rem', fontSize:'0.9rem'}}/></span></Typography>
                </CardContent>

                <CardActions sx={{margin: '4em auto', justifyContent:'space-around', 
                    backgroundColor:'#FAFAFA', borderRadius:'3%', width: '50%'}}>
                  <LightTooltip title='Back'>
                    <IconButton aria-label='Go Back' href='/restaurants'>
                  ...
                  <LightTooltip title='Delete'>
                    <IconButton aria-label='Delete' onClick={()=>removeRestaurant(id)}>
            ...
            <Grid item xs={12} md={6} sx={{margin: '7rem auto'}}>
              <MapBoxRestaurant title={details.title} description={details.description} location={details.location} restaurantId={details._id}/>
              
              <ReviewList toggleUpdate={toggleUpdate} 
                  restaurantId= {details._id} reviews={details.reviews}
