...
function UserPhoto(props) {
    ...
    return(
        <Box
                sx={{width: {xs: '100%', sm: '90%', md:'80%'}, borderRadius: '8px', height: '80%', padding:'4%' }}>
                <form
                    ...
                    <Card 
                     ...
                     {previewSource ? 
                                <img
                                    src={previewSource}
                                    alt="chosen"
                                    style={{ height: '400px', width: 'auto', margin: '5%', 
                                        loading: 'lazy', overflow:'hidden', aspectRatio:'1/1', objectFit:'contain' }}
                                /> : (
                        ...
                        <CardMedia
                            ...
                            height='400px'
                            width='400px'
                            sx={{ loading: 'lazy', overflow:'hidden', aspectRatio:'1/1', objectFit:'contain'}}
                        /> :  
                          
                            <AccountCircleIcon sx={{alignSelf: 'center', fontSize: {xs: '150px', sm: '200px', md: '300px'}}}/>)}
                        <CardActions>
